...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="NeteaseMusic crawler CLI")
    ...
    p_track.add_argument("--snapshots-dir", default="data/netease_snapshots")
    p_track.add_argument("--changes-db", default="data/netease_changes.db")
    ...
    p_report.add_argument("--changes-db", default="data/netease_changes.db")
    ...
    p_toplist.add_argument("--toplist-db", default="data/netease_toplist.db")
    p_toplist.add_argument("--limit", type=int, default=200)
    return parser


def build_client() -> NeteaseMusicClient:
...
def build_snapshot_service(database_url: str) -> Tuple[NeteaseMusicClient, CrawlerService]:
...
def main() -> int:
    ...
    try:
        if args.command == "find-artist":
            ...
            snapshot_file = snapshots_dir / "netease_{}_{}.db".format(artist_mid, ts)
